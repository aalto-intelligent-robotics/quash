...
from vlmaps.utils.index_utils import find_similar_category_id_static
...
class HabitatLanguageRobot(LangRobot):
    ...
    def get_vl_distribution_map_3d(self, name: str, decay_rate: float = 0.1) -> np.ndarray:
        ...
        i = find_similar_category_id_static(name, self.map.categories)
        sim = predict == i
    ...
    def get_gt_region_map(self, name: str, decay_rate: float = 0.1) -> np.ndarray:
        ...
        id = find_similar_category_id_static(name, self.region_categories)
