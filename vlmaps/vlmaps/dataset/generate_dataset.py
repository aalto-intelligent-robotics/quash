...
import sys
sys.path.append("vlmaps")
from vlmaps.utils.habitat_utils import get_obj2cls_dict, get_obj2reg_dict, make_cfg, save_obs
...
def generate_scene_data(save_dir: Union[Path, str], config: DictConfig, scene_path: Path, poses: np.ndarray) -> None:
    ...
    for pose_i, pose in enumerate(pbar):
        ...
        save_obs(save_dir, sim_setting, obs, pose_i, obj2cls, obj2reg)
