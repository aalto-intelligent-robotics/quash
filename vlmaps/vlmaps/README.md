...
* Configure the `config/generate_dataset.yaml`.
    ...
    * Change the `habitat_scene_dir` to the downloaded Matterport3D dataset `/home/user/mp3d_habitat/mp3d`.
        ```
...
3. Open your `/home/user/.bashrc` file, paste a new line `export OPENAI_KEY=<your copied key>`, and save the file.
